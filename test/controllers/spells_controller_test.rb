...
class SpellsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spell" do
    assert_difference('Spell.count') do
      post spells_url, params: { spell: { damage: @spell.damage, description: @spell.description, heal: @spell.heal, mana_cost: @spell.mana_cost, title: @spell.title } }
    end
  ...
  test "should update spell" do
    patch spell_url(@spell), params: { spell: { damage: @spell.damage, description: @spell.description, heal: @spell.heal, mana_cost: @spell.mana_cost, title: @spell.title } }
