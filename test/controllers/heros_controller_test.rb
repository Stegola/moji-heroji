...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { damage: @hero.damage, health: @hero.health, mana: @hero.mana, name: @hero.name, power: @hero.power, rasa: @hero.rasa } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { damage: @hero.damage, health: @hero.health, mana: @hero.mana, name: @hero.name, power: @hero.power, rasa: @hero.rasa } }
